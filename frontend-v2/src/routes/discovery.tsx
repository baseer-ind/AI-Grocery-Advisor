...
const steps: Step[] = [
  {
    ...
    sub: "Tap up to 3, in the order they matter to you — we'll lead with the first one.",
    type: "rank",
    max: 3,
    options: priorities,
  },
...
function Discovery() {
  ...
  return (
    <AppShell title="Household Profile" eyebrow={`Step ${Math.min(stepIdx + 1, steps.length)} of ${steps.length}`}>
      {/* Progress */}

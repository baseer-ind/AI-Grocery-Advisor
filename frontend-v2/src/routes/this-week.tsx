      ...
      <AppShell title="This Week" eyebrow="Pantry & Shopping List">
        <div className="max-w-xl mx-auto text-center rounded-2xl border border-border bg-surface p-10">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            {profile
              ? "Pick whichever is easiest today — every one of these helps us start predicting what's running low. Never invented numbers."
            ...
            {noPantryYet ? (
              <div className="rounded-2xl border border-border bg-surface p-8 text-center">
                <p className="text-sm text-muted-foreground">
                  ...
                  — tell us what you usually buy, or add a bill if that's easier.
                </p>
              </div>
            ) : (
              <>
      ...
      {tab === "Pantry" && (
        <div className="mt-5 space-y-5">
          ...
          {sample ? (
            ...
            <div className="rounded-2xl border border-border bg-surface p-8 text-center">
              <p className="text-sm text-muted-foreground">
                We'll begin predicting your pantry once we understand your shopping habits — tell us
                what you usually buy, or add a couple of bills if that's easier.
              </p>
            </div>
          ) : (
            <Section

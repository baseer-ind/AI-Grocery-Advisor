...
export function FeedbackCta() {
  ...
  return (
    <div className="fixed bottom-[calc(9rem+env(safe-area-inset-bottom))] right-4 lg:bottom-24 lg:right-5 max-w-sm w-[calc(100%-2rem)] sm:w-auto rounded-2xl border border-border bg-surface shadow-2xl p-4 animate-in slide-in-from-bottom-4 z-40">
